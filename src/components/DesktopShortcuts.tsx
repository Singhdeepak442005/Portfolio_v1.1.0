...
const DesktopShortcuts: React.FC<Props> = ({ onOpenTerminal, onOpenWelcome, onOpenResume, hidden, activeTerminal, activeBrowser, activeResume, mobileExpanded }) => {
  return (
    <Grid hidden={hidden} mobileExpanded={mobileExpanded}>
      <DesktopShortcut label="Browser" onOpen={onOpenWelcome} icon={Icons.TorBrowser} active={activeBrowser} />
      <DesktopShortcut label="Terminal" onOpen={onOpenTerminal} icon={Icons.Terminal} active={activeTerminal} />
      <DesktopShortcut label="LinkedIn" href="https://linkedin.com/in/ddeepak-singh" icon={Icons.LinkedIn} />
      <DesktopShortcut label="GitHub" href="https://github.com/Singhdeepak442005" icon={Icons.GitHub} />
      <DesktopShortcut label="TryHackMe" href="https://tryhackme.com/p/kingdomindian67" icon={Icons.TryHackMe} />
