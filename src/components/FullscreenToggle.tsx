...
const FullscreenToggle: React.FC<Props> = ({ isFullscreen, onToggle, hidden }) => {
  return (
    <Wrap hidden={hidden} onClick={onToggle} aria-label={isFullscreen ? "Exit fullscreen" : "Enter fullscreen"}>
